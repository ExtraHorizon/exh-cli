...
describe('exh templates get', () => {
  ...
  it('Fetches a template by name, from template service V2', async () => {
    ...
    expectConsoleLogToContain(JSON.stringify(templateV2, null, 4));
  });

  it('Fetches a template by id, from template service V2', async () => {
  ...
  it('Falls back to V1 if the template is not found in V2', async () => {
    ...
    expectConsoleLogToContain(JSON.stringify(templateV1, null, 4));
  ...
  it('Prints an error message if the template is not found in both V1 and V2', async () => {
    ...
    // By name
    await handler({ name: 'TemplateA' });
    expectConsoleLogToContain('Failed to get template!');
  ...
  it('Ignores the new for template service V2', async () => {
