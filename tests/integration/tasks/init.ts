...
describe('exh tasks init', () => {
  ...
  it('Creates a Function based on a git repository', async () => {
    ...
    expectConsoleLogToContain('Creating new task');
    ...
    expect(taskConfig?.$schema).toBe('https://swagger.extrahorizon.com/cli/1.13.2/config-json-schemas/TaskConfig.json');
