import { loadSingleConfigFile, validateConfig, permissionModes } from '../src/commands/tasks/taskConfig.mjs';
import { limits } from '../src/constants.mjs';
import { noEntryPointConfig, noNameConfig, noPathConfig, noRuntimeConfig, simpleVariableConfig, validFullConfig, wrongPathConfig} from './data/test-configs';
...
const { readFile, stat, access } = await import('fs/promises')
